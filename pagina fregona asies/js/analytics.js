(function() {
    ...
    var O = function(a, b, c) {
        ...
        r.history && r.history.replaceState && (K.test(b) || K.test(c)) && (a = x(a, "path"),
        b = d(b, "?"),
        c = d(c, "#"),
    ...
    function U(a, b, c) {
        b.href && (a = R(a, b.href, void 0 === c ? !1 : c),
        q.test(a) && (b.href = a))
    }
    function T(a, b) {
        if (b && b.action) {
...
(function() {
    ...
    var oe = function() {
      ...
      , ge = function(a, b, c) {
        1 <= 100 * Math.random() || G("?") || (a = ["t=error", "_e=" + a, "_v=j73", "sr=1"],
        b && a.push("_f=" + b),
